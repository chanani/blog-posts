...
<div style="display:flex; overflow-x:auto; scroll-snap-type:x mandatory; gap:0; max-width:520px; margin:0 auto; border-radius:8px;">
  <img src="../../../assets/images/dev/DB/replication_read.png" alt="Master Only 읽기 성능" style="min-width:100%; scroll-snap-align:center; object-fit:contain;">
  <img src="../../../assets/images/dev/DB/replication_read2.png" alt="Master/Slave 읽기 성능" style="min-width:100%; scroll-snap-align:center; object-fit:contain;">
...
<div style="display:flex; overflow-x:auto; scroll-snap-type:x mandatory; gap:0; max-width:520px; margin:0 auto; border-radius:8px;">
  <img src="../../../assets/images/dev/DB/replication_read_write.png" alt="Master Only 읽기 성능" style="min-width:100%; scroll-snap-align:center; object-fit:contain;">
  <img src="../../../assets/images/dev/DB/replication_read_write2.png" alt="Master/Slave 읽기 성능" style="min-width:100%; scroll-snap-align:center; object-fit:contain;">
</div>
<div align="center">
